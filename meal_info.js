...
//fetching meal id from local storage
let id = window.location.search.split('?')[1];
console.log(id);
let meal = JSON.parse(localStorage.getItem(id));
console.log(meal);

//adding meal details on page
...
//using async await method for getting data from themealdb api
 ...
 //getting result from api on window load
window.onload = () => {
